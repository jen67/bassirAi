...
export default function SidebarLayout({ children }: SidebarLayoutProps) {
  ...
  const handleSignOut = async () => {
    document.cookie =
      "sb-mock-session=; path=/; expires=Thu, 01 Jan 1970 00:00:00 UTC;";
    document.cookie =
      "sb-mock-onboarded=; path=/; expires=Thu, 01 Jan 1970 00:00:00 UTC;";
    document.cookie =
      "sb-mock-user-name=; path=/; expires=Thu, 01 Jan 1970 00:00:00 UTC;";
    document.cookie =
      "sb-mock-user-role=; path=/; expires=Thu, 01 Jan 1970 00:00:00 UTC;";
  ...
  return (
    <div
      id="sidebar-layout"
      className="sidebar-layout min-h-screen bg-slate-950 text-white flex flex-col md:flex-row relative overflow-hidden font-sans"
    >
      ...
      <header className="md:hidden bg-slate-900/80 backdrop-blur-xl border-b border-slate-800/80 px-6 py-4 flex justify-between items-center z-30 w-full">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-linear-to-tr from-[#D4AF37] to-amber-500 flex items-center justify-center shadow-md shadow-[#D4AF37]/15">
            <span className="text-slate-950 font-bold text-sm">Z</span>
          </div>
          <span className="font-bold text-sm tracking-wide bg-linear-to-r from-white to-slate-300 bg-clip-text text-transparent">
            Zuri Admin
          </span>
        </div>
        <button
      ...
      <aside className="hidden md:flex md:flex-col md:w-64 bg-slate-900/40 backdrop-blur-xl border-r border-slate-900/60 p-6 z-20 shrink-0">
        <div className="flex items-center gap-3 mb-8">
          <div className="w-10 h-10 rounded-xl bg-linear-to-tr from-[#D4AF37] to-amber-500 flex items-center justify-center shadow-lg shadow-[#D4AF37]/15">
            <span className="text-slate-950 font-extrabold text-lg">Z</span>
          </div>
          <div>
            <h1 className="font-bold text-sm tracking-wide bg-linear-to-r from-white to-slate-200 bg-clip-text text-transparent">
              Zuri Aesthetic
            </h1>
      ...
      <main className="flex-1 px-6 pt-6 md:px-8 md:pt-8 overflow-hidden h-screen z-10 w-full">
        {children}
      </main>
    </div>
  );
